...
{
    public class GroupValueWrite : IDataMessage
    {
        public ApciTypes ApciType => StaticApciType;
        public static ApciTypes StaticApciType => ApciTypes.GroupValueWrite;

        public byte[] Data { get; private set; } = Array.Empty<byte>();

        public GroupValueWrite(byte[] data, ExternalMessageInterfaces emi) {
            switch(emi)
            {
