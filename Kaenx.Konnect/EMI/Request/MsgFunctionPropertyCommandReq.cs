...
{
    /// <summary>
    /// Creates a telegram invoke a function property
    /// </summary>
    public class MsgFunctionPropertyCommandReq : IMessageRequest
    {
        ...
        public ApciTypes ApciType { get; } = ApciTypes.FunctionPropertyCommand;
        ...
        public MsgFunctionPropertyCommandReq(byte objectIndex, byte propertyId, byte[] data, UnicastAddress address)
        {
        ...
        public MsgFunctionPropertyCommandReq() { }
